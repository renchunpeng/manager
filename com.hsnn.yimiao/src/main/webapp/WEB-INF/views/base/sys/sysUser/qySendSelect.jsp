...
<body class="skin-blue-light sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content-header" style="height: 40px;">
		<div class="divatab divnochecked" onclick="searchBy();">未生成账号企业</div>
		<div class="divatab divchecked">已生成账号企业</div>
	</section>
	...
	var obj ={
	        ...
	        "model": [
			        ...
			        { name: "companyAccountCode",width:5, align: 'center' ,sortable: false},
			        { name: "companyName", width: 15, align: 'center' ,sortable: false},
        ...
        $(function () {
            ...
            $("#gridlist").jqGrid({
                url: "${ctx}/sysUser/getQySendSelectList.html",
                mtype: "post",
    ...
    //跳转未生成账号企业
	function searchBy(){
		document.location.href="${ctx}/sysUser/qySelect.html";
	}
    </script>
</body>
</html>