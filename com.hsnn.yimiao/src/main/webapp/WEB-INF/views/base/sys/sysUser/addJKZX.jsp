...
<section class="content">
	<div class="box box-primary center">
		...
		<h3 class="box-title">新增疾控中心</h3>
			<div class="box-tools pull-right">
				<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
			</div>
		</div>
		<div class="box-body">
			<form id="addForm" action="addJKZX.html" method="post">
				<div class="box box-success ">
					<div id="basePage">
						<table class="form-table form-table-2 form-table-info"></table>
						<input type="text" style="display: none;" name="userType" value="4">
						<table class="form-table form-table-2 form-table-info">
							<tbody>
							<tr>
								<th><span class="icon-required" style="color: red">*</span><label class="control-label " style="font-size: 13px;">疾控中心名称：</label></th>	
								<td colspan="3"><input class="form-control" name="hospitalName" id="hospitalName" placeholder="疾控中心名称" style="width:100%;"/></td>		
							</tr>
							<tr>
								...
								<td colspan="3">
									...
									<select class="form-control" id="area3" name="" style="width:200px;"></select>
									<input type="hidden" id="areaId" name="areaId">
								</td>
							</tr>
							<tr>
								<th><span class="icon-required" style="color: red">*</span><label class="control-label " style="font-size: 13px;">申报代表姓名：</label></th>
								<td colspan="3"><input class="form-control" name="legalName" id="legalName" placeholder="申请代表姓名" style="width:100%;"/></td>	
							</tr>
							<tr>
								<th><span class="icon-required" style="color: red">*</span><label class="control-label " style="font-size: 13px;">申报代表电话：</label></th>	
								<td colspan="3"><input class="form-control" name="legalCellphone" id="legalCellphone" placeholder="申请代表联系电话" style="width:100%;"/></td>
							</tr>					
							<tr>
								...
								<td colspan="3"><input class="form-control" id="legalNumber" name="legalNumber" placeholder="申报代表身份证" style="width:100%;"/></td>
							</tr>				
							</tbody>								
						</table>
					</div>
	...
	<script type="text/javascript">
		...
		function valid() {
			if (isNull($("#hospitalName").val())) {
				$.alert("请输入疾控中心名称!", "warn");
				return false;
			}
