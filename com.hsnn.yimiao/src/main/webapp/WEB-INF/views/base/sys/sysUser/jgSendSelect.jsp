...
<body class="skin-blue-light sidebar-mini fixed skin-blue-light-frame">						
    ...
    var obj ={
    		"names": [
    		        ...
    		        "model": [
    		        	{ name: "sysUser.userName", width: 80, align: 'center' ,sortable: false}, 
                        ...
                        { name: "heaBurType", width: 100, align: 'center' ,sortable: false,
                            formatter: function(val,opts,rowdata) {
                                return val == null ? "-":{"5":"市卫计委","4":"市疾控中心","6":"监管机构"}[val];
                            }},
		 ...
		 $(function () {
	         ...
	         $("#gridlist").jqGrid({
	             url: "${ctx }/sysUser/getJgSendSelectList.html",
	             //mtype: "localhost",
	             ...
	             viewrecords: true,
	             multiselect: false,
	             caption: "<spring:message code="已生成账号监管机构列表"/>",
		...
		$(".mySearch").click(function(){
         ...
         function searchBy(){
			...
			document.location.href = "${ctx}/sysUser/jgSelect.html";
		}
    </script>
</body>
</html>