	...
	"model": [
			 {name: 'operate', width: 60, align:"center", sortable: false,
				 formatter : function(val, opts,rowdata) {
						var str="";
                		str += "<a href='javascript:generateAccount(\""+rowdata.hospitalName+"\",\""+rowdata.hospitalId+"\",\""+rowdata.areaId+"\",${userType});' title='生成账号'>生成账号</a>";
						return str;
					}
			 },            
		 ...
		 $(function () {			 
	         $("#gridlist").jqGrid({
	             url: "${ctx }/sysUser/getYySelectList.html",
	             //mtype: "localhost",
	             ...
	             viewrecords: true,
	             multiselect: false,
	             caption: "<spring:message code="未生成账号疾控中心列表"/>",
		...
		//新增
         $("#add").click(function(){
       	  var url= '${ctx}/sysUser/toAddJKZX.html';
       	  $.HN.dialog.open({
		          "id": "quality",
		          "title": "新增疾控中心",
		          "url": url, 
         ...
         function searchBy(){
			...
			document.location.href = "${ctx}/sysUser/toYYSendSelectList.html";
		}
    </script>
</body>
</html>