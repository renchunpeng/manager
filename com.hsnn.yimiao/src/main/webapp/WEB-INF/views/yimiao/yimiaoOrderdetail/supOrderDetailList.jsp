...
var obj={
    "names":['采购数量','入库数量','采购金额(元)','入库金额(元)','订单名称','提交时间','通用名','剂型','规格','包装','单位','生产企业','配送企业','采购医院','订单状态'],
        ...
        {name:"hospitalName", sortable:false, align:'center'},
            ...
            { name: "confirmState", width:80,sortable: false, align: 'center',
                formatter:function(val, opts, rowdata){
        if(rowdata.confirmState=='0'){
            return "待处理";
		}else if(rowdata.confirmState=='1'){
            return "已供货";
		}else if(rowdata.confirmState=='2'){
		    return "不供货";
					}
                }
            },<!-- 验收单状态 -->
