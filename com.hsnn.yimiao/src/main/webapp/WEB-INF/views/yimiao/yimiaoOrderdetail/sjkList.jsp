...
<script type="text/javascript">
	var obj ={
        ...
        "model": [
		        ...
		        { name: "totalWarehouseCount", sortable: false,align:'center'},<!-- 总收货数量 -->
             ...
             gridComplete: function () {
               ...
               //完成率为空的用红色，完成率小于100的用蓝色，完成率为100的用黑色
                 ...
                 //    $('#' + ids[i]).find("td").css("color","white");
                     if(rowData.compRatio=='0.0000'){
                     	$('#' + ids[i]).find("td").css("color","red");
                     }  else if (rowData.compRatio =='100.0000') {
                         $('#' + ids[i]).find("td").css("color","black");
                     }else if (rowData.compRatio!='0.0000'&&rowData.compRatio!='100.0000') {
    ...
    function exportExcel(){
    	...
    	gridParam(postData);
    	$.StandardPost("${ctx}/yimiaoOrderdetail/exportDataToExcelWSJ.html",postData);
