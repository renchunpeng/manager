		...
		<div class=" box box-primary width-control">
			...
			<div class="box-body search-box">
				<form id="searchForm" action="" method="post">
					...
					<input type="hidden" id="hosp" name="hosp" value="${queryMap.adminAreaIdDrug}" />
				</form>
			</div>
		</div>
...
var obj={
	"names":[ 'id','地区','医疗机构','采购金额(元)','撤废金额(元)','退货金额(元)','退货率','入库金额(元)','入库率','查看','其他','医院id'],
	"model":[

        {name:"areaId", sortable:false, align:'center',hidden:true
        },
		{name:"areaName", sortable:false, align:'center'},
...
function initGrid(){
	...
	$("#gridlist").jqGrid({
        url: "${ctx }/yimiaoOrderdetail/getSupHosp.html",
		mtype:"post",
		datatype:"json",
		autowidth:true,
		colNames:obj.names,
