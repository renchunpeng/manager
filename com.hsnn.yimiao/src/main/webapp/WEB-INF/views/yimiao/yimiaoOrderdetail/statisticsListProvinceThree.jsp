			...
			<div class="box-body">
				<form action="${ctx }/yimiaoOrderdetail/getYimiaoOrderdetailData.html" id="searchForm" method="post" >
					<div class="input">
	                    ...
	                    <div class="boxinput">
	                        <input type="text" value="${outlook}" class="textinput" id="outlook" readonly="readonly" name="outlook"  placeholder="规格" maxlength="50" />
	                    </div>
					</div>
					<div class="input">
...
<script type="text/javascript">
	var obj ={
        ...
        "model": [
			...
			{ name: "purchasePrice", width: 150, align: 'center' ,sortable: false},
