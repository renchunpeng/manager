...
<title><spring:message code="医院汇总分析"/></title>
<%@include file="/WEB-INF/component/commonCSS.jsp"%>
</head>
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	<section class="content-header">
		<h1><spring:message code="医院汇总分析" /></h1>
		<ol class="breadcrumb">
			<li><a href="${ctx}/home.html"><i class="fa fa-home"></i><spring:message code="message.lable.first" /></a></li>
			<li class="active"><a href="#"><spring:message code="医院汇总分析" /></a></li>
		</ol>
	</section>
...
var obj={
	...
	"model":[
		...
		{name:"operate", width: 350, align: 'center',sortable: false, align:'center',
			formatter:function(val, opts, rowdata){
				var str = "";
				str += "<a href='javascript:void(0);' onclick='toOtherList(\""+rowdata.hospitalId+"\",\""+rowdata.hospitalName+"\",\"stdArea\")' class='opIcon' title='相关地区'>相关地区</a>";
				str += "<a href='javascript:void(0);' onclick='toOtherList(\""+rowdata.hospitalId+"\",\""+rowdata.hospitalName+"\",\"yimiaoProcurecatalog\")' class='opIcon' title='相关疫苗'>相关疫苗</a>";
				str += "<a href='javascript:void(0);' onclick='toOtherList(\""+rowdata.hospitalId+"\",\""+rowdata.hospitalName+"\",\"stdCompanyPs\")' class='opIcon' title='相关配送企业'>相关配送企业</a>";
				str += "<a href='javascript:void(0);' onclick='toOtherList(\""+rowdata.hospitalId+"\",\""+rowdata.hospitalName+"\",\"stdCompanySc\")' class='opIcon' title='相关生产企业'>相关生产企业</a>";
				return str;
			}
    	},
...
function initGrid(){
	...
	$("#gridlist").jqGrid({
		url:"${ctx}/yimiaoOrderdetail/getHospitalStatistics.html",
		mtype:"post",
		datatype:"json",
		autowidth:true,
		shrinkToFit:false,
...
//跳转页面
function toOtherList(hospitalId,hospitalName,type){
...
function queryCount(){
	...
	var queryData = $("#searchForm").serializeJSON();
	$.ajax({
		url:"${ctx}/yimiaoOrderdetail/getYimiaoHospitalCount.html",
		data:queryData,
		dataType:'json', 
...
$("#exportExcel").click(function(){
	if(queryInit()==false){
		...
		var queryData = $("#searchForm").serializeJSON();
		$.StandardPost("${ctx}/yimiaoOrderdetail/exportDataHospital.html",queryData);
	}
});
</script>
</html>