		...
		<div class=" box box-primary width-control">
			...
			<div class="box-body search-box">
				<form id="searchForm" action="" method="post">
					...
					<input type="hidden" id="companyps" name="companyps" value="1" />
				</form>
			</div>
		</div>
...
var obj={
	"names":[ '配送id','配送企业','采购金额(元)','撤废金额(元)','退货金额(元)','退货率','入库金额(元)','入库率','查看','其他','医院id','s'],
	"model":[
		...
		{name:"wamountTwo",  sortable:false, align:'center'},
        ...
        {name:"hospitalName", sortable:false, align:'center', hidden:true}
	]
};
	...
	$("#gridlist").jqGrid({
        url: "${ctx }/yimiaoOrderdetail/getSupCompany.html",
		mtype:"post",
		datatype:"json",
		autowidth:true,
		colNames:obj.names,
