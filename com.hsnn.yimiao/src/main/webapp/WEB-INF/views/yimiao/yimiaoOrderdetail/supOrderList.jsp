...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content">
		...
		<div id="countDiv" class="btn-control-box width-control" style="margin-top:2px; display:none;">
			统计：采购金额（未减去撤单金额与配送金额）为<span id="purchaseAmountSpan" style="color:red;"></span>元，
			采购数量为<span id="purchaseCountSpan" style="color:red;"></span>，
			退货数量为<span id="totaltdSpan" style="color:red;"></span>，
			入库数量为<span id="totalWarehouseCountSpan" style="color:red;"></span>
		</div>
...
var obj={
	"names":['通用名','剂型','规格','包装','单位','生产企业','配送企业','医疗机构','采购数量','采购金额(元)','退货数量','入库数量','查看详情','医院id','id'],
	"model":[
        ...
        {name:"purchaseCount",  sortable:false, align:'center'},
		...
		{name:"retArrCount", sortable:false, align:'center',},

		{name:"wcountOne",  sortable:false, align:'center'},


		{name:"operate", align: 'center',sortable: false, align:'center',width:350,
			formatter:function(val, opts, rowdata){
				var str = "";
				str += "<a href='javascript:void(0);' onclick='toOtherList(\""+rowdata.hospitalId+"\",\""+rowdata.procurecatalogId+"\",\"yimiaoOrderdetail\",\"supOrderDetailList\")' class='opIcon' title='查看详情'>查看详情</a>";
				return str;
			}
    	},
    	{name:"hospitalId", sortable:false, align:'center', hidden:true},
        {name:"procurecatalogId", sortable:false, align:'center', hidden:true}
	]
};
...
function toOtherList(hospitalId,hospitalName,type,url){
	...
	$("#procurecatalogId").val(hospitalName);
