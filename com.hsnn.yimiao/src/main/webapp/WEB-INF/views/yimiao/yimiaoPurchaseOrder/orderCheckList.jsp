...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	<section class="content-header">
		<h1><spring:message code="采购单审核记录"/></h1>
		<ol class="breadcrumb">
			<li><a href="${ctx }/home.jsp"><i class="fa fa-home"></i><spring:message code="message.lable.first"/></a></li>
			<li class="active"><a href="#"><spring:message code="采购单审核记录"/></a></li>
		</ol>
	</section>
...
<script type="text/javascript">
        ...
        "model": [
      			{ name: 'operate', width: 40, align: 'center',sortable: false,
                  	formatter:function(val, opts, rowdata){
            			var str =  "<a href='${ctx }/yimiaoPurchaseOrder/toCheckOrderDetailList.html?orderId=" + rowdata.orderId + "'  >详情</a>";
            			return str;
                      }
              	},
	...
	$(function(){
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoPurchaseOrder/getOrderData.html",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: false,
            caption: "采购单审核记录列表"
