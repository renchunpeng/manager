...
var obj ={
        ...
        "model": [
				{ name: "totalReturnCount", sortable: false,width: 50,},
				{ name: "returnReason", sortable: false,width: 150,},
				{ name: "totalReturnAmount", sortable: false,width: 70,
	...
	$(function(){
		...
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoPurchaseOrder/getretDetails.html",
            colNames: obj.names,
            colModel: obj.model,
            postData: queryData,
            multiselect: false,
