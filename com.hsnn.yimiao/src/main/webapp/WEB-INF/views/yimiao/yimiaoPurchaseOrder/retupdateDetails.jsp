...
/* 			'<spring:message code="yimiaoOrderdetail.splitCompanyName"/>',
        ...
        "model": [
            	...
            	formatter:function(val, opts, rowdata){
            		var str =  "<a href='${ctx }/yimiaoOrderdetail/getretDelete.html?orderdetailId=" + rowdata.orderdetailId + "' >删除</a>";
                	return str;
           	     }
        		},
	...
	$(function(){
		...
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoOrderdetail/getretYimiaoOrderdetailData.html",
            colNames: obj.names,
            colModel: obj.model,
            postData: queryData,
            multiselect: true,
	...
	function goAdd(){
		window.location.href="${ctx}/yimiaoPurchaseOrder/getretNotProcureList.html?orderId=${orderId}";
	}
