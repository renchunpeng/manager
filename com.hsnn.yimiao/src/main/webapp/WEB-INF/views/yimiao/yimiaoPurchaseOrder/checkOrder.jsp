...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	<section class="content-header">
		<h1><spring:message code="采购订单审核"/></h1>
		<ol class="breadcrumb">
			<li><a href="${ctx }/home.jsp"><i class="fa fa-home"></i><spring:message code="message.lable.first"/></a></li>
			<li class="active"><a href="#"><spring:message code="采购订单审核"/></a></li>
		</ol>
	</section>
...
<script type="text/javascript">
        ...
        "model": [
      			{ name: 'operate', width: 120, align: 'center',sortable: false,
                  	formatter:function(val, opts, rowdata){
            			var str =  "<a href='${ctx }/yimiaoPurchaseOrder/toCheckOrderDetails.html?orderId=" + rowdata.orderId + "'  >详情</a>";
            			return str;
                      }
              	},
	...
	$(function(){
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoPurchaseOrder/getSubmitOrder.html",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: true,
            caption: "订单列表"
	...
	function pass(obj) {
        ...
        $.HN.message.confirm('确定'+statusName+'吗？', '', '').on(function (e) {
            if (e) {
                $.ajax({
                    url:"${ctx }/yimiaoPurchaseOrder/checkOrder.html",
                    type:"post",
                    dataType : "json",
