...
<script type="text/javascript">
	var obj ={
        ...
        "model": [
		        ...
		        { name: "outlook", sortable: false,align:'center'},<!-- 规格 -->
		        { name: "companyNameSc", sortable: false,align:'center'},<!-- 生产企业名称 -->
	...
	$(function(){
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoOrderdetailRet/getYimiaoOrderdetailRetData.html?ratio=0&isUsing=1",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: false,
            shrinkToFit :false,
		...
		$("#search").click(function(){
			...
			$("#gridlist").jqGrid("setGridParam", {
				url: "${ctx }/yimiaoOrderdetailRet/getYimiaoOrderdetailRetData.html?confirmState=1&isUsing=1",
    ...
    function exportExcel(){
    	...
    	gridParam(postData);
    	$.StandardPost("${ctx}/yimiaoOrderdetail/exportDataToExcelPSRET.html",postData);
	}
    var objTemp = null;
