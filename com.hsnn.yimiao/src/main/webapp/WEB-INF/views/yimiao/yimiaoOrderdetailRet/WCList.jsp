...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#">已完成退货记录</a></li>
			...
			<div class="box-body">
				<form action="${ctx }/yimiaoOrderdetail/getYimiaoOrderdetailData.html" id="searchForm" method="post" >
					...
					<div class="input">
	                    ...
	                    <div class="boxinput">
	                        <input type="text" class="textinput"  id="companyNamePs" name="companyNamePs"  placeholder="采购单位" maxlength="50" />
	                    </div>
...
var obj ={
        ...
        "model": [
		        ...
		        { name: "goodsId", sortable: false,align:'center'},<!-- 通用名 -->
            ...
            { name: "companyNameSc", width: 150, align: 'center' ,sortable: false,
		        ...
		        { name: "orderCustomInfo", sortable: false,align:'center'},
		        ...
		        { name: "orderdetailState", sortable: false,hidden:false,align:'center',
                    formatter : function(val, opts, rowdata) {
                        var orderstate = rowdata.orderdetailState;
		        ...
		        { name: "companyNamePs", sortable: false,hidden:false,align:'center'},<!-- 配送企业名称 -->
	...
	$(function(){
		$("#gridlist").jqGrid({
            url: "${ctx }/yimiaoOrderdetailRet/getYimiaoOrderdetailRetFinData.html",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: false,
            shrinkToFit :false,
    ...
    function exportExcel(){
    	...
    	gridParam(postData);
    	$.StandardPost("${ctx}/yimiaoOrderdetail/exportDataToExcelSC.html",postData);
	}
    var objTemp = null;
