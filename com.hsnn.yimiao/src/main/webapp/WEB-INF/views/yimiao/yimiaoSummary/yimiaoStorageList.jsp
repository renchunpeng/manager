...
<section class="content-header">
	<h1><spring:message code="入库统计"/></h1>
	<ol class="breadcrumb">
		...
		<li class="active"><a href="#"><spring:message code="入库统计"/></a></li>
	</ol>
</section>
...
<script type="text/javascript">
    var obj ={
        ...
        "model": [
            ...
            { name: "confirmState", width: 90, align: 'center', sortable: false,hidden:true,
            ...
            { name: "orderCustomInfo", width: 100, align: 'center', sortable: false,hidden:true,
                formatter:function(val, opts, rowdata){
    ...
    $(function(){
        $("#gridlist").jqGrid({
            url: "${ctx}/yimiaoSummary/getYimiaoStorageData.html",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: false,
            caption: "入库列表",
    ...
    function exportExcel(){
        ...
        gridParam(postData);
        $.StandardPost("${ctx}/yimiaoOrderdetail/exportDataToExcelCatalog.html",postData);
