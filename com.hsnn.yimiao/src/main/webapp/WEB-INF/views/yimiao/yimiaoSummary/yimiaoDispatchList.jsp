...
<section class="content-header">
	<h1><spring:message code="配送统计"/></h1>
	<ol class="breadcrumb">
		...
		<li class="active"><a href="#"><spring:message code="配送统计"/></a></li>
	</ol>
</section>
...
<script type="text/javascript">
    ...
    $(function(){
        $("#gridlist").jqGrid({
            url: "${ctx}/yimiaoSummary/getYimiaoDispatchData.html",
            colNames: obj.names,
            colModel: obj.model,
            multiselect: false,
            caption: "配送列表",
    ...
    function exportExcel(){
        ...
        gridParam(postData);
        $.StandardPost("${ctx}/yimiaoOrderdetail/exportDataToExcelDispatch.html",postData);
