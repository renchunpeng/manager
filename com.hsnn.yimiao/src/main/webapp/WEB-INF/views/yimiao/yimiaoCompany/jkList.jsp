	...
	<section class="content" >
		<div class=" box box-primary">
				...
				<div class="box-body">
					...
					<div class="boxinput">
				                <input type="text" class="textinput" id="prodCompName" name="prodCompName" placeholder="生产企业名称" maxlength="100" />
				     </div>
				     
				     
				     <div class="textalign">生产企业状态：</div>
					 <div class="boxinput">
				          <select id="prodCompStatus">
				...
				<span class="desc" id="prodCompCode">${model.prodCompCode}</span>
				</div>
...
<script type="text/javascript">
	...
	var obj ={
        ...
        "model": [
				{ name: "oper", width: 100, align: 'center' ,sortable: false,
					formatter:function(val, opts, rowdata){
                        var prodCompCode="'"+rowdata.prodCompCode+"'";
                        return '<a href="javascript:void(0)"  onclick="editRelation('+prodCompCode+');">编 辑</a>';
					}
				},
				{ name: 'prodCompName', width: 100, align: 'center',sortable: false},
		        { name: "prodCompNameSpel", width: 80, align: 'center' ,sortable: false,hidden:true},
		        { name: "prodCompStatus", width: 100, align: 'center' ,sortable: false,
		        	formatter:function(val, opts, rowdata){	
		        ...
		        { name: "updDatetime", width: 100, align: 'center' ,sortable: false,hidden:false,hidden:true,
		        	formatter:function(val, opts, rowdata){	
		        		if (val != null) {
	...
	$(function(){
		...
		$("#search").click(function(){
			...
			var prodCompStatus=$.trim($("#prodCompStatus").val());
			$("#gridlist").jqGrid("setGridParam", {
				mtype: "post",
				url: "${ctx }/yimiaoCompany/getYimiaoDelrelationData.html",
				postData: {"delCompName":delCompName,"delCompStatus":delCompStatus,
					"prodCompName":prodCompName,"prodCompStatus":prodCompStatus},//发送查询条件 
	 ...
	 // 去编辑页面
     function editRelation(prodCompCode){
         var prod = prodCompCode;
         window.location.href="${ctx}/yimiaoCompany/toEdit.html?prodCompCode="+prod;
	 }
