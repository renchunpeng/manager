	...
	<section class="content" >
		<div class=" box box-primary">
				...
				<div class="boxinput">
				 ...
				 <div class="boxinput">
			          <select class="boxinput" id="prodCompStatus">
...
<script type="text/javascript">
	...
	var obj ={
        ...
        "model": [
				{ name: 'prodCompName', width: 80, align: 'center',sortable: false},
		        { name: "prodCompNameSpel", width: 80, align: 'center' ,sortable: false,hidden:true},
		        { name: "prodCompStatus", width: 220, align: 'center' ,sortable: false,
		        	formatter:function(val, opts, rowdata){	
	                	return {0:"停用",1:"启用"}[val];
	                }	
		        },
		        { name: "delCompName", width: 100, align: 'center' ,sortable: false,hidden:true},
		        { name: "delCompNameSpel", width: 90, align: 'center' ,sortable: false,hidden:true},
		        { name: "delCompStatus", width: 100, align: 'center' ,sortable: false,hidden:true,
		        	formatter:function(val, opts, rowdata){	
	                	return {0:"停用",1:"启用"}[val];
	                }	
		        },
	...
	$(function(){
		...
		$("#search").click(function(){
			...
			$("#gridlist").jqGrid("setGridParam", {
				mtype: "post",
				url: "${ctx }/yimiaoCompany/getYimiaoDelrelationData.html",
				postData: {"prodCompName":prodCompName,"prodCompStatus":prodCompStatus},//发送查询条件 
