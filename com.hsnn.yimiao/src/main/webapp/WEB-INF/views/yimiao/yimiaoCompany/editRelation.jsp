...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content">
		<div class=" box box-primary">
			...
			%>
			<span class="desc" style="display: none;" id="prodCompCode">${prodCompCode}</span>
		</div>
...
<script type="text/javascript">
	...
	$(function(){
		var prodCompCode = $("#prodCompCode").html();
		$("#gridlist").jqGrid({
            url:"${ctx }/yimiaoCompany/getYimiaoDelrelationDataByprodCompCode.html" ,
            postData: {"prodCompCode":prodCompCode},
