...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#gridlist").jqGrid({
            ...
            multiselect: false,
            viewrecords: true,
            caption: "配送企业列表  月度:${date}/生产企业:${prodName}/采购金额(万元):${total}/配送金额(万元):${delA}/入库金额(万元):${recpA}",
    ...
    function exportExcel() {
        ...
        var postData = {date: "${date}", dateType: "${dateType}", type: "${type}", prodCode: "${prodCode}", delCompName: $.trim($("#delCompName").val())};
        gridParam(postData);
    ...
    function xgTz(delCode, total, delA, recpA, type) {
        var url = encodeURI(encodeURI("${ctx}/anaDruginfo/toAnaByProdcompTzThree.html?dateType=mon&date=" + "${date}" + "&total=" + total + "&type=" + type + "&prodCode=${prodCode}&delCode=" + delCode + "&delA=" + delA + "&recpA=" + recpA));
        //type 1医疗机构2药品3配送企业
