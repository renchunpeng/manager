...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#gridlist").jqGrid({
            ...
            multiselect: false,
            viewrecords: true,
            caption: "疫苗列表  月度:${date}/采购金额(万元):${total}/配送金额(万元):${del}/入库金额(万元):${recp}",
    ...
    function exportExcel() {
        var postData = {date: "${date}", dateType: "${dateType}", type: "${type}", drugName: $.trim($("#drugName").val()), drugCat: $.trim($("#drugCat").val())};
        gridParam(postData);
