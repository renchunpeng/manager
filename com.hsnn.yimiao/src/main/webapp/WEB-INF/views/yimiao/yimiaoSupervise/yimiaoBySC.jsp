...
<section class="content-header">
	<h1><spring:message code="生产企业采购情况"/></h1>
	<ol class="breadcrumb">
		...
		<li class="active"><a href="#"><spring:message code="生产企业采购情况"/></a></li>
	</ol>
</section>
...
<script type="text/javascript">
    var obj ={
        ...
        "model": [
            {name:'oper',index:'formName', width:100, align:"center", sortable:false,formatter:function(val,option,rowdata){
                    ...
                    var str = "<a href='javascript:void(0)' onclick=\"xgTz('"+rowdata.companyIdSc+"','"+rowdata.companyNameSc+"','"+date+"','"+rowdata.purchaseAmount+"','"+rowdata.purchaseAmount+"','"+rowdata.totalWarehouseAmount+"','2')\" style='background:url(${ctx}/lib/img/icon/icon.png) no-repeat -40px -80px' class='opIcon' title='采购药品'></a>";
                    str += "<a href='javascript:void(0)' onclick=\"xgTz('"+rowdata.companyIdSc+"','"+rowdata.companyNameSc+"','"+date+"','"+rowdata.purchaseAmount+"','"+rowdata.purchaseAmount+"','"+rowdata.totalWarehouseAmount+"','1')\" style='background:url(${ctx}/lib/img/icon/icon.png) no-repeat -20px -120px' class='opIcon' title='采购医院'></a>";
                    str += "<a href='javascript:void(0)' onclick=\"xgTz('"+rowdata.companyIdSc+"','"+rowdata.companyNameSc+"','"+date+"','"+rowdata.purchaseAmount+"','"+rowdata.purchaseAmount+"','"+rowdata.totalWarehouseAmount+"','3')\" style='background:url(${ctx}/lib/img/icon/icon.png) no-repeat -120px -60px' class='opIcon' title='采购配送企业'></a>";
                    return str;
                }},
            ...
            { name: 'companyNameSc', width: 80, align:"center", sortable: false},
    ...
    $(function(){
        ...
        $("#gridlist").jqGrid({
            url: "${ctx}/yimiaoSupervise/getDataBySC.html",
            mtype: "post",
            datatype: "json",
            height: 310,
            autowidth: true,
    ...
    function xgTz(prodCode,prodName,date,total,delA,recpA,type) {
        //type 1医疗机构2药品3配送企业4地区
        window.location.href= "${ctx}/yimiaoSupervise/toAnaByProdcompTz.html?dateType=mon&date="+date+"&total="+total+"&type="+type+"&prodCode="+prodCode+"&prodName="+prodName+"&delA="+delA+"&recpA="+recpA;
    }
    ...
    function exportExcel(){
        ...
        gridParam(postData);
        $.StandardPost("${ctx}/yimiaoSupervise/exportExcelWithSC.html",postData);
