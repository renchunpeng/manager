			...
			<div class="box-body search-box">
				<form id="searchForm" action="" method="post">
					<div class="input">
						...
						<div class="boxinput">
							<input type="text" class="textinput" id="dictionaryValue" name="dictionaryValue" maxlength="140" />
						</div>
					</div>
...
var obj={
	"names":['通用名id','通用名'],
	"model":[
	    {name:'dictionaryKey', sortable:false, align:"center", hidden:true, key:true},
		{name:'dictionaryValue', width:80, align:"center", sortable:false}
	]
};
...
$(function(){
	...
	$("#gridlist").jqGrid({
		url:"${ctx}/dialog/getProductInfo.html",
		colNames:obj.names,
		colModel:obj.model,
		postData: queryData,
		multiselect:false,
