 ...
 *
 */
public class YimiaoPurchaseReturnForm  {

	//columns START
	
	/**
	 * @Fields RET_ORDER_ID:order_id（有序guid编号）
	 */
	...
	public YimiaoPurchaseReturnForm(){
	}

	public YimiaoPurchaseReturnForm(String retOrderId){
