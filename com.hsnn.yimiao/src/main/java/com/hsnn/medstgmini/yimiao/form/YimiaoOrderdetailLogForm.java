 ...
 * @Description: TODO
 * @author ***
 * @date 2016-11-23 17:03:07
 *
 */
public class YimiaoOrderdetailLogForm  {
	...
	/**
	 * @Fields ORDERDETAIL_ID:order_detail_id（有序guid编号）
	 */
	@NotEmpty(message = "请填写order_detail_id（有序guid编号）")
	@Length(max = 36, message = "order_detail_id（有序guid编号）的长度不能超过{1}")
	...
	/**
	 * @Fields COMPANY_ID_SC:生产企业id
	 */
	@Length(max = 36, message = "生产企业id的长度不能超过{1}")
	private String companyIdSc;
	//columns END
	

	public YimiaoOrderdetailLogForm(){
	}

	public YimiaoOrderdetailLogForm(String orderdetailId){
