package com.hsnn.medstgmini.common.util.gzca.util;
...
public class GzcaUtil {
    ...
    public static String hexString2String(String hex_string) {
        ...
        while(hex_string != null && hex_string.length() >= 2) {
            try {
                ...
                log.error("HexString2StringError.NumberFormatException", var3);
            }
        }
    ...
    public static String md5Encode(String data) {
        ...
        try {
            ...
            log.error("md5EncodeString.NoSuchAlgorithmException", var5);
        }
    ...
    public static String sha1Encode(String data) {
        ...
        try {
            ...
            log.error("sha1EncodeString.NoSuchAlgorithmException", var4);
        }
