 ...
 * @Description: TODO
 * @author ***
 * @date 2016-11-22 10:22:13
 *
 */
public class YimiaoOrderdetail  implements ICreateInfo, IUpdateInfo{
	
	//alias
	public static final String TABLE_ALIAS = "疫苗_订单明细表";
	
	//columns START
	/**
	 * @Fields orderdetailId:订单明细Id
	 */
	...
	//入库数量
	private String wcountOne;
	//入库金额
	private String wamountOne;
	//入库完成率
	private String cratioOne;
	//退货数量
	private String wcountTwo;
	//退货金额
	private String wamountTwo;
	//退货完成率
	private String cratioTwo;
	//退货到货数量
	private String retArrCount;
	//退货到货金额
	private String retArrAmount;

	private String cghospitalName;
	private String cgsubmitTime;
	private String cgconfirmTime;
	private String thhospitalName;
	private String thsubmitTime;
	private String thconfirmTime;
	
	private String tjareaName;
	/**
	 * @Fields orderId:订单Id
	 */
	...
	//委托配送企业名称
	private String wtCompanyNamePs;
	...
	public YimiaoOrderdetail(){
	}

	public YimiaoOrderdetail(String orderdetailId){
	...
	public String getWcountOne() {
		return wcountOne;
	}

	public void setWcountOne(String wcountOne) {
		this.wcountOne = wcountOne;
	}

	public String getWamountOne() {
		return wamountOne;
	}

	public void setWamountOne(String wamountOne) {
		this.wamountOne = wamountOne;
	}

	public String getCratioOne() {
		return cratioOne;
	}

	public void setCratioOne(String cratioOne) {
		this.cratioOne = cratioOne;
	}

	public String getWcountTwo() {
		return wcountTwo;
	}

	public void setWcountTwo(String wcountTwo) {
		this.wcountTwo = wcountTwo;
	}

	public String getWamountTwo() {
		return wamountTwo;
	}

	public void setWamountTwo(String wamountTwo) {
		this.wamountTwo = wamountTwo;
	}

	public String getCratioTwo() {
		return cratioTwo;
	}

	public void setCratioTwo(String cratioTwo) {
		this.cratioTwo = cratioTwo;
	}

	public String getCghospitalName() {
		return cghospitalName;
	}

	public void setCghospitalName(String cghospitalName) {
		this.cghospitalName = cghospitalName;
	}

	public String getCgsubmitTime() {
		return cgsubmitTime;
	}

	public void setCgsubmitTime(String cgsubmitTime) {
		this.cgsubmitTime = cgsubmitTime;
	}

	public String getCgconfirmTime() {
		return cgconfirmTime;
	}

	public void setCgconfirmTime(String cgconfirmTime) {
		this.cgconfirmTime = cgconfirmTime;
	}

	public String getThhospitalName() {
		return thhospitalName;
	}

	public void setThhospitalName(String thhospitalName) {
		this.thhospitalName = thhospitalName;
	}

	public String getThsubmitTime() {
		return thsubmitTime;
	}

	public void setThsubmitTime(String thsubmitTime) {
		this.thsubmitTime = thsubmitTime;
	}

	public String getThconfirmTime() {
		return thconfirmTime;
	}

	public void setThconfirmTime(String thconfirmTime) {
		this.thconfirmTime = thconfirmTime;
	}

	public String getTjareaName() {
		return tjareaName;
	}

	public void setTjareaName(String tjareaName) {
		this.tjareaName = tjareaName;
	}

	public String getRetArrCount() {
		return retArrCount;
	}

	public void setRetArrCount(String retArrCount) {
		this.retArrCount = retArrCount;
	}

	public String getRetArrAmount() {
		return retArrAmount;
	}

	public void setRetArrAmount(String retArrAmount) {
		this.retArrAmount = retArrAmount;
	}
	...
	public String getWtCompanyNamePs() {
		return wtCompanyNamePs;
	}

	public void setWtCompanyNamePs(String wtCompanyNamePs) {
		this.wtCompanyNamePs = wtCompanyNamePs;
	}
}