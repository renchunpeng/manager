 ...
 * @Description: TODO
 * @author ***
 * @date 2016-11-25 16:10:05
 *
 */
public class YimiaoOrderdetailLog  implements ICreateInfo, IUpdateInfo{
	
	//alias
	public static final String TABLE_ALIAS = "疫苗_订单明细日志表";
	...
	public YimiaoOrderdetailLog(){
	}

	public YimiaoOrderdetailLog(String logId){
		this.logId = logId;
	}
