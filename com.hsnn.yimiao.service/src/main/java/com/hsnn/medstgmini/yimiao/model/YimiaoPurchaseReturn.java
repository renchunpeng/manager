 ...
 * @Description: TODO
 * @author ***
 * @date 2016-11-29 16:19:33
 *
 */
public class YimiaoPurchaseReturn  implements ICreateInfo, IUpdateInfo{
	
	//alias
	public static final String TABLE_ALIAS = "疫苗_退货单";
	
	//columns START
	/**
	 * @Fields retOrderId:order_id（有序guid编号）
	 */
	...
	/**
	 * @Fields orderRamarks:订单备注
	 */
	private String orderRamarks;
	...
	public YimiaoPurchaseReturn(){
	}

	public YimiaoPurchaseReturn(String retOrderId){
	...
	public void setOrderRamarks(String orderRamarks){
		this.orderRamarks = orderRamarks;
	}
	
	public String getOrderRamarks(){
		return orderRamarks;
	}
