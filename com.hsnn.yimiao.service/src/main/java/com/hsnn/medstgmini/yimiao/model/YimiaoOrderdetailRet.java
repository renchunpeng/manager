 ...
 * @Description: TODO
 * @author ***
 * @date 2016-11-28 09:01:26
 *
 */
public class YimiaoOrderdetailRet  implements ICreateInfo, IUpdateInfo{
	
	//alias
	public static final String TABLE_ALIAS = "疫苗_退货单明细表";
	...
	public YimiaoOrderdetailRet(){
	}

	public YimiaoOrderdetailRet(String orderdetailRetId){
	...
	public YimiaoOrderdetailRet(String orderdetailRetId, String companyIdPs, String companyNamePs, Integer confirmState,
			String refuseReason, BigDecimal totalReturnAmount, Integer totalReturnCount, BigDecimal compRatio) {
		super();
		this.orderdetailRetId = orderdetailRetId;
