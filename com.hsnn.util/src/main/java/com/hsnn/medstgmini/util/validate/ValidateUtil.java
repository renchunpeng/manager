...
import com.hsnn.medstgmini.util.validate.parse.DigitsParse;
import com.hsnn.medstgmini.util.validate.parse.EmailParse;
import com.hsnn.medstgmini.util.validate.parse.ExtistParse;
import com.hsnn.medstgmini.util.validate.parse.IValidateParse;
import com.hsnn.medstgmini.util.validate.parse.LengthParse;
import com.hsnn.medstgmini.util.validate.parse.MaxParse;
import com.hsnn.medstgmini.util.validate.parse.MinParse;
import com.hsnn.medstgmini.util.validate.parse.NotEmptyParse;
import com.hsnn.medstgmini.util.validate.parse.NotNullParse;
import com.hsnn.medstgmini.util.validate.parse.PatternParse;
import com.hsnn.medstgmini.util.validate.parse.RangeParse;
import com.hsnn.medstgmini.util.validate.parse.SizeParse;
