...
public class Constants {
	...
	public final static short COMPLAIN_STATUS_0 = 0;  //申诉状态0.提交1.申诉通过2申诉不通过
	public final static String COMPLAIN_STATUS_STRING_0 = "0";  //申诉状态0.提交1.申诉通过2申诉不通过
	public final static short COMPLAIN_STATUS_1 = 1; //申诉状态0.提交1.申诉通过2申诉不通过
	public final static short COMPLAIN_STATUS_2 = 2;//申诉状态0.提交1.申诉通过2申诉不通过
...
//	public final static String EERY_AREA_PS_COMP_ID = "998dd1be-23d0-11e5-9cc0-40f2e9d2c708";//每区县配送企业数,每区县配送企业最大数量，0不限制，其它整数为最大数量
	...
	public final static int ZX = 5; //用户类型：中心
	public final static int SC = 1; //生产企业
	public final static int JY = 2; //经营企业
	public final static int SCJY = 3; //生产经营企业
	public final static int YY = 4; //医疗机构
	public final static int ZJia = 8; //专家
	...
	public final static int STD_JIXING = 17;             //剂型
	public final static int STD_PINGGUI = 13;            //品规
	public final static int SYS_COMPLAIN = 18;      		 //申投诉编码
	...
	public final static String STD_JIXING_PREFIX = "JX";  		 //剂型
	public final static String STD_PINGGUI_PREFIX = "PG";        //品规
	public final static String SYS_COMPLAIN_PREFIX = "STS";  	 //申投诉编码前缀
	...
	public final static int STD_JIXING_LEN = 8;               //剂型
	public final static int STD_PINGGUI_LEN = 8;              //品规
	public final static int SYS_COMPLAIN_LEN = 8;             //申投诉编码	
	...
	public final static String INTERFACE_PARAM_COUNT_TIP = "参数条数不能大于";
}
