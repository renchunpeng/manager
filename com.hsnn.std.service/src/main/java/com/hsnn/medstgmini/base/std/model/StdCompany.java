 ...
 *
 */
public class StdCompany implements IAttachment<String>, Serializable  {
	...
	/**
	 * @Fields representativeName:申报代表姓名
	 */
	private String representativeName;
	
	/**
	 * @Fields representativeIdNumber:申报代表身份证号
	 */
	private String representativeIdNumber;
	
	/**
	 * @Fields representativePhone:申报代表电话
	 */
	...
	private transient Attachment attachmentLegalScanAttachId;
	
	
	public StdCompany(){
	}

	public StdCompany(String companyId){
	...
	public Attachment getAttachmentLegalScanAttachId() {
		return attachmentLegalScanAttachId;
	}

	public void setAttachmentLegalScanAttachId(
			Attachment attachmentLegalScanAttachId) {
		this.attachmentLegalScanAttachId = attachmentLegalScanAttachId;
	}
	...
	public void setAttachment(Attachment attachment) {
		this.attachmentLegalScanAttachId = attachment;
	}
	...
	public Integer getWeiyueNum() {
		return weiyueNum;
	}

	public void setWeiyueNum(Integer weiyueNum) {
		this.weiyueNum = weiyueNum;
	}
