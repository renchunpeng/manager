...
import com.hsnn.medstgmini.base.std.dao.StdOaDispatchDao;
import com.hsnn.medstgmini.base.std.model.StdOaDispatch;
import com.hsnn.medstgmini.base.std.service.StdOaDispatchManager;
...
@Service
public class StdOaDispatchManagerImpl extends GenericManagerImpl<StdOaDispatch, String> implements StdOaDispatchManager {
	@Autowired
	private StdOaDispatchDao stdOaDispatchDao;
	...
	public int updateStatusById(Map<String, Object> map) {
		...
		return stdOaDispatchDao.updateStatusById(map);
	}
}